...
def publishOdom():
	...
	soc.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEADDR, 1)#udp zu播
	network = "224.0.0.7"
	soc.setsockopt(socket.IPPROTO_IP,socket.IP_ADD_MEMBERSHIP,socket.inet_aton(network)+socket.inet_aton("0.0.0.0"))
